...
<body class="theme-cyan font-montserrat light_version">
                    ...
                    <ul id="main-menu" class="metismenu">
                        ...
                        <li class="active open">
                            ...
                            <ul>
                                ...
                                <li class="active"><a href="<?php echo base_url('Deals/statistic'); ?>"><?php echo lang('Statistics');?></a></li>
        ...
        <div class="container-fluid">                        
            ...
            <div class="row clearfix">
                <div class="col-xl-6">
                    <div class="card">
                        <div class="header">
                            <h2><?php echo lang('Uploaded Deals by User');?></h2>
                        </div>
                        <div class="body">
                            <!-- <div class="row clearfix"> -->
                                <div class="col-12">
                                    <div class='dateselection-box'>
                                        <select class="custom-select" id="dateSelector">
                                            <option value='2'><?php echo lang('Active');?></option>
                                    ...
                                    <div id = "userDatePickerBox">
                                        <div class="datepicker-box">
                                            <div>
                                                <span><?php echo lang('Start Date');?> : </span>
                                                <input data-provide="datepicker" style="width: 110px;" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="startUserDate" class="form-control" onkeyup="checkEnterkey(event)" value="">
                                            </div>
                                            &nbsp;&nbsp;&nbsp;
                                            <div>
                                                <span><?php echo lang('End Date');?> : </span>
                                                <input data-provide="datepicker" style="width: 110px;" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="endUserDate" class="form-control" onkeyup="checkEnterkey(event)" value="">
                                            </div>                                                                          
                                        </div>    
                                        <hr>                        
                                    </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        <div class="header">
                            <h2><?php echo lang('Deals by Deal Type');?></h2>
                        </div>
                        <div class="body">                            
                            <div class="col-12">                                
                                <div class='dateselection-box'>
                                    <select class="custom-select" id="DealsByDealTypeDateSelector">
                                        <option value="2"><?php echo lang('Active');?></option>
                                        <option value="0"><?php echo lang('Today');?></option>
                                        <option value="1"><?php echo lang('Yesterday');?></option>
                                        <option value="7"><?php echo lang('Last 7 Days');?></option>
                                ...
                                <div id = "DealsByDealTypeDatePickerBox">
                                    <div class="datepicker-box">
                                        <div>
                                            <span><?php echo lang('Start Date');?> : </span>
                                            <input data-provide="datepicker" style="width: 110px;" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="DealsByDealTypeStartDate" class="form-control" onkeyup="checkEnterkey(event)" value="">
                                        </div>
                                        &nbsp;&nbsp;&nbsp;
                                        <div>
                                            <span><?php echo lang('End Date');?> : </span>
                                            <input data-provide="datepicker" style="width: 110px;" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="DealsByDealTypeEndDate" class="form-control" onkeyup="checkEnterkey(event)" value="">
                                        </div>                                                                          
                                    </div>    
                                    <hr>                        
                                </div>
                                <div class="tab-content">
                                    <div class="tab-pane active show">
                                        <div class="big-text">
                                            <h2 id="total_Count_by_category"></h2>
                                        </div>
                                        <div id="detail_statistic_category_box">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2><?php echo lang('Deals by Equipment Category');?></h2>
                        </div>
                        <div class="body">
                            <div class="col-12">     
                                <div class='dateselection-box'>
                                    <select class="custom-select" id="DealsByEquipmentCategoryDateSelector">
                                        <option value="2"><?php echo lang('Active');?></option>
                                        <option value="0"><?php echo lang('Today');?></option>
                                        <option value="1"><?php echo lang('Yesterday');?></option>
                                        <option value="7"><?php echo lang('Last 7 Days');?></option>
                                ...
                                <div id = "DealsByEquipmentCategoryDatePickerBox">
                                    <div class="datepicker-box">
                                        <div>
                                            <span><?php echo lang('Start Date');?> : </span>
                                            <input data-provide="datepicker" style="width: 110px;" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="DealsByEquipmentCategoryStartDate" class="form-control" onkeyup="checkEnterkey(event)" value="">
                                        </div>
                                        &nbsp;&nbsp;&nbsp;
                                        <div>
                                            <span><?php echo lang('End Date');?> : </span>
                                            <input data-provide="datepicker" style="width: 110px;" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="DealsByEquipmentCategoryEndDate" class="form-control" onkeyup="checkEnterkey(event)" value="">
                                        </div>                                                                          
                                    </div>    
                                    <hr>                        
                                </div>                           
                                <div class="tab-content">
                                    <div class="tab-pane active show">
                                        <div id="detail_statistic_deal_tye_box">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="<?php echo base_url('assets/js/pages/statistic.js'); ?>?<?php echo time(); ?>"></script>
    <!-- Custom Javascript -->

...
<body class="theme-cyan font-montserrat light_version"  onload='set_interval();'>
    ...
    <div id="wrapper">
                    ...
                    <ul id="main-menu" class="metismenu">
                        ...
                        <!-- <li class='active open'>
                            ...
                            <ul>
                                ...
                                <li  class='active'><a href="<?php echo base_url('Sales/mine'); ?>"><?php echo lang('My Sales');?></a></li>
        ...
        <div id="main-content">
            <div class="container-fluid truck-table-container">
                ...
                <div class="modal fade" id="LogisticsModal" tabindex="-1" role="dialog" aria-labelledby="LogisticsTitle" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="LogisticsTitle"><?php echo lang('Logistics');?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-round btn-default" data-dismiss="modal"><?php echo lang('Close');?></button>
                                <button type="button" class="btn btn-round btn-default" id='btnLogisticsSave'><?php echo lang('Select Deal');?></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="CloseModal" tabindex="-1" role="dialog" aria-labelledby="CloseTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-round btn-default" data-dismiss="modal"><?php echo lang('Cancel');?></button>
                                <button type="button" class="btn btn-round btn-primary" id="btnCloseSale"><?php echo lang('Close');?></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="ContactModal" tabindex="-1" role="dialog" aria-labelledby="ContactTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <div class="modal-body text-left">
                                <form id='contactForm'>         
                                    <div class='form-group'>
                                        <label><?php echo lang('Contact Date');?></label>
                                        <input data-provide="datepicker" data-date-autoclose="true" data-date-format="yyyy-mm-dd" id="ContactDate" class="form-control" value="" require>
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo lang('Notes');?></label>
                                        <textarea class="form-control" id="ContactNote" rows='5' col='30'></textarea>
                                    </div>                                         
                                </form>
                            </div>
                            <div class="modal-footer">
                ...
                <div class="modal fade" id="NoteModal" tabindex="-1" role="dialog" aria-labelledby="ContactTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="ContactTitle"><?php echo lang('Add Note');?></h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>                            
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-round btn-default" data-dismiss="modal"><?php echo lang('Cancel');?></button>
                                <button type="button" class="btn btn-round btn-primary" id="btnNote"><?php echo lang('Save');?></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal fade" id="editCusomterModal" tabindex="-1" role="dialog" aria-labelledby="EditLeadTitle" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document" style='max-width : 900px;'>
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-round btn-default" data-dismiss="modal"><?php echo lang('Cancel');?></button>
                                <button type="button" class="btn btn-round btn-primary" id="btnUpdateCustomer"><?php echo lang('Save');?></button>
                            </div>
                        </div>
                    </div>
                </div>     
                ...
                <div class='SaleDocument' id='SaleDocument'>
                    ...
                    <div class='deal-info'>
                        ...
                        <div class='content'>
                            ...
                            <div class='total-price'>
                                <p>Total<span id='total-price' style='margin-left: 8px;'></span></p>
                            </div>
                        </div>
                    </div>
                    <div class='signature'>
                    ...
                    <div class='footer'>
                        <p>COPYRIGHT © Heavy Equipment Manager. DERECHOS RESERVADOS. MARCAS Y DISTINTIVOS PERTENECEN A SUS RESPECTIVAS MARCAS PROPIETARIAS.</p>
    ...
    <script src="<?php echo base_url('assets/js/pages/sales/my-sales-management.js'); ?>?<?php echo time(); ?>"></script>
